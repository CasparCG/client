#include "RundownSonyPresetWidget.h"
...
RundownSonyPresetWidget::RundownSonyPresetWidget(const LibraryModel& model, QWidget* parent, const QString& color, bool active,
...
AbstractRundownWidget* RundownSonyPresetWidget::clone()
{
    RundownSonyPresetWidget* widget = new RundownSonyPresetWidget(this->model, this->parentWidget(), this->color, this->active,
...
void RundownSonyPresetWidget::setCompactView(bool compactView)
{
    if (compactView)
    {
...
void RundownSonyPresetWidget::readProperties(boost::property_tree::wptree& pt)
{
...
bool RundownSonyPresetWidget::isInGroup() const
{
    return this->inGroup;
}

AbstractCommand* RundownSonyPresetWidget::getCommand()
{
    return &this->command;
}

LibraryModel* RundownSonyPresetWidget::getLibraryModel()
{
    return &this->model;
}

void RundownSonyPresetWidget::setSelected(bool selected)
{
    this->selected = selected;
}

void RundownSonyPresetWidget::setActive(bool active)
{
    this->active = active;
...
void RundownSonyPresetWidget::setInGroup(bool inGroup)
{
    this->inGroup = inGroup;
    this->labelGroupColor->setVisible(this->inGroup);
}

QString RundownSonyPresetWidget::getColor() const
{
    return this->color;
}

void RundownSonyPresetWidget::setColor(const QString& color)
{
    this->color = color;
    this->setStyleSheet(QString("#frameItem, #frameStatus { background-color: %1; }").arg(color));
}

void RundownSonyPresetWidget::clearDelayedCommands()
{
...
bool RundownSonyPresetWidget::executeCommand(Playout::PlayoutType type)
{
...
void RundownSonyPresetWidget::executeStop()
{
    this->executeTimer.stop();
}
...
void RundownSonyPresetWidget::delayChanged(int delay)
{
    this->labelDelay->setText(QString("Delay: %1").arg(delay));
}

void RundownSonyPresetWidget::checkGpiConnection()
{
...
void RundownSonyPresetWidget::gpiConnectionStateChanged(bool connected, GpiDevice* device)
{
    Q_UNUSED(connected);
    Q_UNUSED(device);
...
void RundownSonyPresetWidget::remoteTriggerIdChanged(const QString& remoteTriggerId)
{
...
void RundownSonyPresetWidget::stopControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownSonyPresetWidget::playControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownSonyPresetWidget::playNowControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownSonyPresetWidget::updateControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownSonyPresetWidget::clearControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownSonyPresetWidget::clearVideolayerControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownSonyPresetWidget::clearChannelControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
