...
#include "ui_RundownAtemCutWidget.h"
...
class WIDGETS_EXPORT RundownAtemCutWidget : public QWidget, Ui::RundownAtemCutWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownAtemCutWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
