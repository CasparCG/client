...
#include "ui_RundownAtemAudioGainWidget.h"
...
class WIDGETS_EXPORT RundownAtemAudioGainWidget : public QWidget, Ui::RundownAtemAudioGainWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    ...
    public:
        explicit RundownAtemAudioGainWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
