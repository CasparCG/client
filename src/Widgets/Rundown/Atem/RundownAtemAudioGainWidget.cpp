#include "RundownAtemAudioGainWidget.h"
...
void RundownAtemAudioGainWidget::preview(const PreviewEvent& event)
{
    Q_UNUSED(event);
...
AbstractRundownWidget* RundownAtemAudioGainWidget::clone()
{
    RundownAtemAudioGainWidget* widget = new RundownAtemAudioGainWidget(this->model, this->parentWidget(), this->color, this->active,
                                                                          this->inGroup, this->compactView);

    AtemAudioGainCommand* command = dynamic_cast<AtemAudioGainCommand*>(widget->getCommand());
...
void RundownAtemAudioGainWidget::setCompactView(bool compactView)
{
    if (compactView)
    {
...
void RundownAtemAudioGainWidget::readProperties(boost::property_tree::wptree& pt)
{
    if (pt.count(L"color") > 0) setColor(QString::fromStdWString(pt.get<std::wstring>(L"color")));
}

void RundownAtemAudioGainWidget::writeProperties(QXmlStreamWriter& writer)
{
    writer.writeTextElement("color", this->color);
}

bool RundownAtemAudioGainWidget::isGroup() const
{
    return false;
}

bool RundownAtemAudioGainWidget::isInGroup() const
{
    return this->inGroup;
}

AbstractCommand* RundownAtemAudioGainWidget::getCommand()
{
    return &this->command;
}

LibraryModel* RundownAtemAudioGainWidget::getLibraryModel()
{
    return &this->model;
}

void RundownAtemAudioGainWidget::setSelected(bool selected)
{
    this->selected = selected;
}

void RundownAtemAudioGainWidget::setActive(bool active)
{
    this->active = active;
...
void RundownAtemAudioGainWidget::setInGroup(bool inGroup)
{
...
void RundownAtemAudioGainWidget::checkEmptyDevice()
{
...
void RundownAtemAudioGainWidget::clearDelayedCommands()
{
    this->executeTimer.stop();
}

void RundownAtemAudioGainWidget::setUsed(bool used)
{
    if (used)
    {
...
bool RundownAtemAudioGainWidget::executeCommand(Playout::PlayoutType type)
{
...
void RundownAtemAudioGainWidget::delayChanged(int delay)
{
    this->labelDelay->setText(QString("Delay: %1").arg(delay));
}

void RundownAtemAudioGainWidget::checkGpiConnection()
{
...
void RundownAtemAudioGainWidget::checkDeviceConnection()
{
    const QSharedPointer<AtemDevice> device = AtemDeviceManager::getInstance().getDeviceByName(this->model.getDeviceName());
    if (device == NULL)
...
void RundownAtemAudioGainWidget::configureOscSubscriptions()
{
...
void RundownAtemAudioGainWidget::allowGpiChanged(bool allowGpi)
{
    Q_UNUSED(allowGpi);
...
void RundownAtemAudioGainWidget::gpiConnectionStateChanged(bool connected, GpiDevice* device)
{
    Q_UNUSED(connected);
    Q_UNUSED(device);
...
void RundownAtemAudioGainWidget::remoteTriggerIdChanged(const QString& remoteTriggerId)
{
...
void RundownAtemAudioGainWidget::deviceConnectionStateChanged(AtemDevice& device)
{
    Q_UNUSED(device);
...
void RundownAtemAudioGainWidget::deviceAdded(AtemDevice& device)
{
...
void RundownAtemAudioGainWidget::playControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownAtemAudioGainWidget::playNowControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownAtemAudioGainWidget::updateControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
