...
#include "ui_RundownAtemFadeToBlackWidget.h"
...
class WIDGETS_EXPORT RundownAtemFadeToBlackWidget : public QWidget, Ui::RundownAtemFadeToBlackWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownAtemFadeToBlackWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
