...
#include "ui_RundownAtemInputWidget.h"
...
class WIDGETS_EXPORT RundownAtemInputWidget : public QWidget, Ui::RundownAtemInputWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    ...
    public:
        explicit RundownAtemInputWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
