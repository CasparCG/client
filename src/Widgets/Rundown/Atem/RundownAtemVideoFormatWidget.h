...
#include "ui_RundownAtemVideoFormatWidget.h"
...
class WIDGETS_EXPORT RundownAtemVideoFormatWidget : public QWidget, Ui::RundownAtemVideoFormatWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownAtemVideoFormatWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
