#include "RundownAtemAudioInputBalanceWidget.h"
...
void RundownAtemAudioInputBalanceWidget::labelChanged(const LabelChangedEvent& event)
{
    // This event is not for us.
    if (!this->selected)
        return;
...
void RundownAtemAudioInputBalanceWidget::atemDeviceChanged(const AtemDeviceChangedEvent& event)
{
    // This event is not for us.
    if (!this->selected)
        return;
...
AbstractRundownWidget* RundownAtemAudioInputBalanceWidget::clone()
{
    RundownAtemAudioInputBalanceWidget* widget = new RundownAtemAudioInputBalanceWidget(this->model, this->parentWidget(), this->color, this->active,
...
void RundownAtemAudioInputBalanceWidget::setCompactView(bool compactView)
{
    if (compactView)
    {
...
void RundownAtemAudioInputBalanceWidget::readProperties(boost::property_tree::wptree& pt)
{
...
bool RundownAtemAudioInputBalanceWidget::isInGroup() const
{
    return this->inGroup;
}

AbstractCommand* RundownAtemAudioInputBalanceWidget::getCommand()
{
    return &this->command;
}

LibraryModel* RundownAtemAudioInputBalanceWidget::getLibraryModel()
{
    return &this->model;
}

void RundownAtemAudioInputBalanceWidget::setSelected(bool selected)
{
    this->selected = selected;
}

void RundownAtemAudioInputBalanceWidget::setActive(bool active)
{
    this->active = active;
...
void RundownAtemAudioInputBalanceWidget::setInGroup(bool inGroup)
{
    this->inGroup = inGroup;
    this->labelGroupColor->setVisible(this->inGroup);
}

QString RundownAtemAudioInputBalanceWidget::getColor() const
{
    return this->color;
}

void RundownAtemAudioInputBalanceWidget::setColor(const QString& color)
{
    this->color = color;
    this->setStyleSheet(QString("#frameItem, #frameStatus { background-color: %1; }").arg(color));
}

void RundownAtemAudioInputBalanceWidget::checkEmptyDevice()
{
...
bool RundownAtemAudioInputBalanceWidget::executeCommand(Playout::PlayoutType type)
{
...
void RundownAtemAudioInputBalanceWidget::checkGpiConnection()
{
...
void RundownAtemAudioInputBalanceWidget::checkDeviceConnection()
{
    const QSharedPointer<AtemDevice> device = AtemDeviceManager::getInstance().getDeviceByName(this->model.getDeviceName());
    if (device == NULL)
...
void RundownAtemAudioInputBalanceWidget::allowGpiChanged(bool allowGpi)
{
    Q_UNUSED(allowGpi);
...
void RundownAtemAudioInputBalanceWidget::gpiConnectionStateChanged(bool connected, GpiDevice* device)
{
    Q_UNUSED(connected);
    Q_UNUSED(device);
...
void RundownAtemAudioInputBalanceWidget::remoteTriggerIdChanged(const QString& remoteTriggerId)
{
...
void RundownAtemAudioInputBalanceWidget::deviceConnectionStateChanged(AtemDevice& device)
{
    Q_UNUSED(device);
...
void RundownAtemAudioInputBalanceWidget::deviceAdded(AtemDevice& device)
{
...
void RundownAtemAudioInputBalanceWidget::playControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownAtemAudioInputBalanceWidget::playNowControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownAtemAudioInputBalanceWidget::updateControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
