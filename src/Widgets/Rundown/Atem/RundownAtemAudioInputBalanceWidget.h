...
#include "ui_RundownAtemAudioInputBalanceWidget.h"
...
class WIDGETS_EXPORT RundownAtemAudioInputBalanceWidget : public QWidget, Ui::RundownAtemAudioInputBalanceWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownAtemAudioInputBalanceWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
