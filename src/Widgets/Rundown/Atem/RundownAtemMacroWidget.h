...
#include "ui_RundownAtemMacroWidget.h"
...
class WIDGETS_EXPORT RundownAtemMacroWidget : public QWidget, Ui::RundownAtemMacroWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownAtemMacroWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
