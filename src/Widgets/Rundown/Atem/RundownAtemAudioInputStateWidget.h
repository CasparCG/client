...
#include "ui_RundownAtemAudioInputStateWidget.h"
...
class WIDGETS_EXPORT RundownAtemAudioInputStateWidget : public QWidget, Ui::RundownAtemAudioInputStateWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownAtemAudioInputStateWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
