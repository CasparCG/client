...
void RundownBlendModeWidget::executeStop()
{
    ...
    if (device != NULL && device->isConnected())
        device->setBlendMode(this->command.channel.get(), this->command.getVideolayer(), "Normal");
    ...
    foreach (const DeviceModel& model, DeviceManager::getInstance().getDeviceModels())
    {
        ...
        if (deviceShadow != NULL && deviceShadow->isConnected())
            deviceShadow->setBlendMode(this->command.channel.get(), this->command.getVideolayer(), "Normal");
    }
}
...
void RundownBlendModeWidget::executePlay()
{
    const QSharedPointer<CasparDevice> device = DeviceManager::getInstance().getDeviceByName(this->model.getDeviceName());
    if (device != NULL && device->isConnected())
        device->setBlendMode(this->command.channel.get(), this->command.getVideolayer(), this->command.getBlendMode());
    ...
    foreach (const DeviceModel& model, DeviceManager::getInstance().getDeviceModels())
    {
        ...
        const QSharedPointer<CasparDevice>  deviceShadow = DeviceManager::getInstance().getDeviceByName(model.getName());
        if (deviceShadow != NULL && deviceShadow->isConnected())
            deviceShadow->setBlendMode(this->command.channel.get(), this->command.getVideolayer(), this->command.getBlendMode());
    }
