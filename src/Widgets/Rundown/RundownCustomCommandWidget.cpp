...
bool RundownCustomCommandWidget::eventFilter(QObject* target, QEvent* event)
{
...
bool RundownCustomCommandWidget::executeCommand(enum Playout::PlayoutType::Type type)
{
