...
void RundownMacroWidget::clearDelayedCommands()
{
    this->executeTimer.stop();
}

void RundownMacroWidget::setUsed(bool used)
{
    if (used)
    {
...
bool RundownMacroWidget::executeCommand(Playout::PlayoutType type)
{
...
void RundownMacroWidget::playNowControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
