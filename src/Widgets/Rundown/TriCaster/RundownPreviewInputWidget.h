...
#include "ui_RundownPreviewInputWidget.h"
...
class WIDGETS_EXPORT RundownPreviewInputWidget : public QWidget, Ui::RundownPreviewInputWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownPreviewInputWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
