...
void RundownPresetWidget::setSelected(bool selected)
{
...
bool RundownPresetWidget::executeCommand(Playout::PlayoutType type)
{
...
void RundownPresetWidget::playNowControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
