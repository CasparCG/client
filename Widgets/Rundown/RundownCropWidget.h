...
class WIDGETS_EXPORT RundownCropWidget : public QWidget, Ui::RundownCropWidget, public IRundownWidget, public IPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownCropWidget(const LibraryModel& model, QWidget* parent = 0,
