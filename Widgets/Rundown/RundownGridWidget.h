...
class WIDGETS_EXPORT RundownGridWidget : public QWidget, Ui::RundownGridWidget, public IRundownWidget, public IPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownGridWidget(const LibraryModel& model, QWidget* parent = 0,
