...
class WIDGETS_EXPORT RundownSaturationWidget : public QWidget, Ui::RundownSaturationWidget, public IRundownWidget, public IPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownSaturationWidget(const LibraryModel& model, QWidget* parent = 0,
