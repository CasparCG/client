...
class WIDGETS_EXPORT RundownCommitWidget : public QWidget, Ui::RundownCommitWidget, public IRundownWidget, public IPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownCommitWidget(const LibraryModel& model, QWidget* parent = 0,
