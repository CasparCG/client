...
class WIDGETS_EXPORT RundownContrastWidget : public QWidget, Ui::RundownContrastWidget, public IRundownWidget, public IPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownContrastWidget(const LibraryModel& model, QWidget* parent = 0,
