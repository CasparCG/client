...
AudioCommand::AudioCommand(QObject* parent)
    : AbstractCommand(parent),
      audioName(Audio::DEFAULT_AUDIO_NAME), transition(Mixer::DEFAULT_TRANSITION), duration(Mixer::DEFAULT_DURATION),
      tween(Mixer::DEFAULT_TWEEN), direction(Mixer::DEFAULT_DIRECTION), loop(Audio::DEFAULT_LOOP),
      triggerOnNext(Media::DEFAULT_TRIGGER_ON_NEXT), useAuto(Audio::DEFAULT_USE_AUTO)
{
}
